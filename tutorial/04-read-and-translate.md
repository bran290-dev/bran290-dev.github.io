...
번역된 소설을 더 편하게 읽으려면 디스플레이 설정을 조정해 보세요.

### 설정 열기

뷰어 상단의 **More 메뉴**(&#8942;)를 열고 **"디스플레이 설정"** 항목을 선택합니다.

### 주요 설정 항목

**글자 설정**:
- 폰트 크기, 패밀리(나눔고딕, 고운돋움, 나눔명조, 고운바탕 등), 굵기를 조절할 수 있어요
- 직접 폰트 파일을 등록해서 사용할 수도 있어요

**배경 설정**:
- 30종의 번들 배경(종이, 나무, 한지, 패브릭 등)을 선택하거나 직접 이미지를 설정할 수 있어요
- 배경에 따라 텍스트 색상도 자동으로 맞춰져요

**기타 설정**:
- 줄 간격, 문단 간격, 화면 유지 등을 취향에 맞게 조정할 수 있어요

> 자세한 내용은 [디스플레이 설정 가이드](../reading/display-settings.md)를 참고하세요.
